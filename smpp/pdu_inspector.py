...
def detect_multipart(pdu):
    ...
    if short_message[0:1] == '\x05' and \
       short_message[1:2] == '\x00' and \
       short_message[2:3] == '\x03' and \
       len(short_message) >= 6:
    ...
    if short_message[0:1] == '\x06' and \
       short_message[1:2] == '\x00' and \
       short_message[2:3] == '\x04' and \
       len(short_message) >= 7:
